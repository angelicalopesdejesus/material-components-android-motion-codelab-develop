...
class HomeFragment : Fragment(), EmailAdapter.EmailAdapterListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /*qualquer transição de entrada a ser executada será mantida até
                que uma chamada de fechamento para startPostponedEnterTransition
        seja chamada. Isso nos dá a oportunidade de "agendar" nossas transições até que o RecyclerView
        tenha sido preenchido com e-mails e a
        transição seja capaz de encontrar os mapeamentos que você configurou*/
    ...
    override fun onEmailClicked(cardView: View, email: Email) {
        //  Set up MaterialElevationScale transition as exit and reenter transitions.
